...
namespace ReadSpectrum7
{
    internal class FilesDown
    {
        ...
        public List<FilesDown> ReadFilesDown(OracleConnection cn)
        {
            ...
            try
            {
                command.CommandText = "select file_pattern , server_path , type  , count(*) from schedule_files_sp7 where file_pattern like 'YYYYMMDD-900%' group by file_pattern, server_path, type   ";
        ...
        public int ReadLast15Min(DateTime fecha , OracleConnection cn)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new OracleParameter("p_fecha", (object)fecha.Date));
